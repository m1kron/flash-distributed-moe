...
# Core lib name/dir (default matches your error: libflashMoe.so)
flash_moe_lib_name = os.environ.get("FLASH_MOE_LIB_NAME", "flashMoe")
flash_moe_lib_dir = os.environ.get("FLASH_MOE_LIB_DIR", str(out_dir))

class BuildExtensionToBuildDir(BuildExtension):
    def finalize_options(self):
        super().finalize_options()
        # Emit the Python module into /home/REPO/flash-moe/build
...
setup(
    ...
    ext_modules=[
        CUDAExtension(
            name="moe_launcher",
            sources=[str(project_root / "python" / "py_moe_launcher_torch_hip.cpp")],
            ...
            define_macros=[("TORCH_EXTENSION_NAME", "moe_launcher")],
            extra_link_args=[
