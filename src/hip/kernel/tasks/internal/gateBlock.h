...
template <typename T_GATE_GEMM_TILE, int TOPK>
__device__ void gate_block(
    const typename T_GATE_GEMM_TILE::TType* __restrict__ tokens,
    const typename T_GATE_GEMM_TILE::TType* __restrict__ gateWeights,
